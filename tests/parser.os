...
Процедура РазбиениеДДВМассивПростой() Экспорт
	...
	// Когда
	Результат = Парсеры.РазделитьДвоичныеДанныеРазделителемВМассив(ДанныеФормыДД, ПолучитьДвоичныеДанныеИзСтроки("-----------------------------347652832615407563483504145195"));
...
Процедура ПолучениеДанныхФормы() Экспорт
	...
	ВходящийЗапрос.Заголовки.Вставить("Content-Type", "multipart/form-data; boundary=-----------------------------347652832615407563483504145195");
