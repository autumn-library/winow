...
&Тест
Процедура Должен_ПроверитьРаспаковкуУпаковкуСообщенийВебСокета() Экспорт
	// Дано
	...
	// Результат2 = Новый ДвоичныеДанные(ОбъединитьПути(Каталог, "features/client2"));
...
// Должен_ПроверитьРаспаковкуУпаковкуСообщенийВебСокета();
