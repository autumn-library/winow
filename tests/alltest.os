...
Процедура ПередЗапускомТеста() Экспорт	
	...
	ЭтоВерсия2 = Лев(Новый СистемнаяИнформация().Версия,1) = "2";
...
Функция ГетЗапрос(АдресТеста, Заголовки = Неопределено)
	Соединение = Новый HTTPСоединение("http://localhost",3333,,,,500);
...
&Тест
Процедура Должен_ПроверитьОбработкуПостЗапросаКакТипизированныйОбъект() Экспорт
...
&Тест
Процедура Должен_ПроверитьПолучениеФайлаКастомногоУрла() Экспорт
