...
Функция СписокЖелудей()
	...
	Список = "ВебСервер, Настройки, СлушательПорта, ОбработчикСоединений, ПарсерСоединений, ВходящийЗапрос, 
			| МенеджерПриложений, Маршрутизатор, ФабрикаОтветов, Ответ, Перечисления, ОтправщикОтветов, Парсеры,
			| Кука, Куки, Сессия, МенеджерСессий, Шаблон, МенеджерОтображений, ФабрикаШаблонов";
