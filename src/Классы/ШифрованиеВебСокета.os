...
Функция ЗапаковатьСообщениеТекстовоеСообщение(Сообщение) Экспорт
	...
	ДвоичныеДанныеСообщения = ПреобразоватьВДвоичныеДанныеСообщения(Сообщение);
...
Функция РаспаковатьСообщение(ДвоичныеДанныеСообщения) Экспорт
	...
	Возврат ПолучитьСтрокуИзДвоичныхДанных(СоединитьДвоичныеДанные(Результат));
КонецФункции
...
Функция ПреобразоватьВДвоичныеДанныеСообщения(Сообщение)
	МассивСообщения = ТекстВМассивДвоичныеДанныеДляСообщения(Сообщение);
	Результат = Новый Массив();
	СчетчикСимволов = 0;
