...
Функция СформироватьПараметрыТочкиМаршрута(Действие, ТребуемыеПараметры, ТипТелаЗапроса, ВходящийЗапрос, Ответ, Сессия) Экспорт

	ЗначенияПараметров = ЗначенияПараметровДляТочкиМаршрута(ВходящийЗапрос, ТипТелаЗапроса, Ответ, Сессия);
...
Функция ЗначенияПараметровДляТочкиМаршрута(ВходящийЗапрос, ТипТелаЗапроса, Ответ, Сессия)
	Значения = Новый Соответствие();	
	ДополнитьСоответствие(Значения, ВходящийЗапрос.ЗначенияПараметровДляТочкиМаршрута(ТипТелаЗапроса));
