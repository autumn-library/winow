...
Процедура РегистрацияФайла(РасположениеНаСайте, ПутьНаДиске, ТипКонтента) Экспорт
	...
	// TODO: Заполнение полной ТЗ.
	// Либо е добавить в описание маршрута спец поле для типа тела объектом, тогда не надо будет везде протаскивать эту
	// ТЗ.
	ПараметрыОписание = Новый ТаблицаЗначений;
	ПараметрыОписание.Колонки.Добавить("Имя");
	ПараметрыОписание.Добавить().Имя = "Запрос";
	ПараметрыОписание.Добавить().Имя = "Ответ";
	...
	Действие.ПараметрыОписание = ПараметрыОписание;
