...
Функция НайтиОбработчикИПараметрыПоПолномуПути(ПолныйПуть) Экспорт
	...
	Структура.Действие = НайтиОбработчикРекурсивно(СтрокиМаршрута, ТочкиМаршрута, СчетчикПути);
...
Функция НайтиОбработчикРекурсивно(Строки, ТочкиМаршрута, СчетчикПути)
	...
	Если ЗначениеЗаполнено(НайденнаяСтрока.Действие) Тогда
		Возврат НайденнаяСтрока.Действие;
	КонецЕсли;
	...
	Иначе
		...
		Возврат НайтиОбработчикРекурсивно(НайденнаяСтрока.Строки, ТочкиМаршрута, СчетчикПути);
	КонецЕсли;
