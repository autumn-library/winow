...
Функция ОписаниеТочкиМаршрута() Экспорт
	...
	КолонкиДействия = "УрлСодержитШаблон, АдресКонтроллера, Желудь, ИмяМетода, Параметры, ПараметрыУРЛ,"
		+ " Шаблон, МетодШаблона, ПараметрыШаблона, ВыводитьШаблонКонтрола, ТипТелаЗапроса, ШаблонПути,"
		+ " HTTPМетоды, Сводка";
	Действие = Новый Структура(КолонкиДействия, Ложь, "");
	Возврат Действие;
