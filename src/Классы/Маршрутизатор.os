...
Функция ОписаниеТочкиМаршрута() Экспорт
	...
	Действие = Новый Структура("УрлСодержитШаблон, АдресКонтроллера, Желудь, ИмяМетода, Параметры, ПараметрыУРЛ, Шаблон, МетодШаблона, ПараметрыШаблона, ВыводитьШаблонКонтрола, ТипТелаЗапроса"
								, Ложь, "");
	Возврат Действие;
