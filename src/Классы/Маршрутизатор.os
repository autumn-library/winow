...
Функция ОписаниеТочкиМаршрута() Экспорт
	...
	Действие = Новый Структура("УрлСодержитШаблон, АдресКонтроллера, Желудь, ИмяМетода, Параметры, ПараметрыУРЛ, Шаблон, МетодШаблона, ПараметрыШаблона, ВыводитьШаблонКонтрола, ТипТелаЗапроса, ШаблонПути, HTTPМетоды, Сводка"
								, Ложь, "");
	Возврат Действие;
