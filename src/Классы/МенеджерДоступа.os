...
Функция ПолучитьРолиТочкиМаршрута(Действие) Экспорт
	Роли = Новый Массив();
	Для Каждого Строка Из ТаблицаРолейТочекМаршрутов.НайтиСтроки(Новый Структура("Действие", Действие)) Цикл
		Роли.Добавить(Строка.Роль);
	КонецЦикла;
	Возврат Роли;
КонецФункции
