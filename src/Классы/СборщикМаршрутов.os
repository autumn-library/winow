...
Процедура ЗарегистрироватьМаршрутКОбъекту(АдресКонтроллера, ТочкаМаршрута, Желудь)
	...
	// TODO: Чтобы не сломать все остальное. Проверить, может быть можно просто в Параметры сгрузить ТЗ.
	// Полное описание параметров для поддержки дополнительных метаданных (например, &Тип)
	Действие.ПараметрыОписание = ТочкаМаршрута.Параметры;
