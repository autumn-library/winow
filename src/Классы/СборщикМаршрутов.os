...
Процедура НайтиИЗарегистрироватьМаршруты(Желудь) Экспорт
	...
	Лог.Информация(СтрШаблон("Регистрация контрола %1 по адресу %2", Желудь, АдресКонтроллера));
...
Процедура ЗарегистрироватьМаршрутКОбъекту(АдресКонтроллера, ТочкаМаршрута, Желудь)
	...
	Лог.Информация(СтрШаблон("Регистрация точки маршрута контрола %1 по адресу %2", Желудь, ПутьКМетоду));
