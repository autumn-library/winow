...
Процедура ПриСозданииОбъекта()
	СостоянияОтветов = Новый ФиксированнаяСтруктура(СостоянияОтветов());
	ОписанияТиповРасширенийФайлов = Новый ФиксированноеСоответствие(ОписанияТиповРасширенийФайлов());
