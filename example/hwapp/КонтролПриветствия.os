...
&Операция(Сводка = "Страница с отображением")
&ТочкаМаршрута("view")
...
&Операция(Сводка = "Корневая страница примера")
&ТочкаМаршрута("")
...
&Операция(Сводка = "Демонстрация страницы ошибки")
...
&Операция(Сводка = "Перенаправление на другой адрес")
