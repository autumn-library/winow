...
&Группа("Веб-сокеты", Описание = "Точки маршрута, работающие поверх веб-сокетов")
&Контроллер("/console")
Процедура ПриСозданииОбъекта()

КонецПроцедуры

&Операция(Сводка = "Канал веб-сокета для консоли")
&ТочкаМаршрута("run")
...
&Операция(Сводка = "Страница веб-консоли")
&ТочкаМаршрута("")
