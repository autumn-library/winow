&Пластилин Перем Перечисления Экспорт;
&Пластилин Перем Парсеры Экспорт;
...
Процедура ЗагрузкаФайла(ВходящийЗапрос, Ответ, Сессия) Экспорт
	...
	Разделитель = Перечисления.Разделитель;
	
	РазделенныйЗапрос = Парсеры.РазделитьДвоичныеДанныеРазделителем(ВходящийЗапрос.ТелоДвоичныеДанные, ПолучитьДвоичныеДанныеИзСтроки(Разделитель + Разделитель));
