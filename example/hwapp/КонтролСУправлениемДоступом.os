...
&Тег("Доступ", Описание = "Точки маршрута с проверкой ролей")
&Контроллер("/sec")
...
&Сводка("Страница для роли Пользователи")
&Роли("Пользователи")
&ТочкаМаршрута("user")
...
&Сводка("Страница для роли Администраторы")
&Роли("Администраторы")
&ТочкаМаршрута("admin")
...
&Сводка("Страница без проверки ролей")
&ТочкаМаршрута("free")
Процедура Все(Ответ) Экспорт
	Ответ.ТелоТекст = "Все подрят";
КонецПроцедуры

&Сводка("Страница сразу для двух ролей")
