...
&Операция(Сводка = "Тело запроса как нетипизированный объект")
...
&Операция(Сводка = "Тело запроса как типизированный объект")
...
&Операция(Сводка = "Параметры строки запроса по именам")
...
&Операция(Сводка = "Умножение через шаблон пути")
...
&Операция(Сводка = "Несколько параметров пути подряд")
...
&Операция(Сводка = "Произвольные параметры строки запроса")
...
&Операция(Сводка = "Калькулятор на позиционных сегментах пути")
&ТочкаМаршрута("calc")
...
&Операция(Сводка = "Форма возведения в степень")
...
&Операция(Сводка = "Результат возведения в степень")
...
&Операция(Сводка = "Установить куку")
...
&Операция(Сводка = "Прочитать куку")
...
&Операция(Сводка = "Записать данные в сессию")
...
&Операция(Сводка = "Прочитать данные сессии")
