...
Процедура ПриСозданииОбъекта(&Пластилин ТопикиСерверныхСобытий, &Пластилин ПодпискиСерверныхСобытий)
	...
	ПодпискиСерверныхСобытий.ПодпискаНаОткрытие(ИмяТопика, Новый Действие(ЭтотОбъект, "НовоеПодключениеССЕ"));
	ПодпискиСерверныхСобытий.ПодпискаНаЗакрытие(ИмяТопика, Новый Действие(ЭтотОбъект, "ОтключениеССЕ"));
